...
const faqs = [
  ...
  { q: "ひとり親家庭の支援制度にはどんなものがありますか？", a: "児童扶養手当（月額最大4万5,500円）、医療費助成（マル親）、学習支援・就労支援、家賃補助制度などがあります。詳しくは子育て支援課（☎0439-88-1111 内線241）へ。" },
];
...
const facilityInfo = [
  { name: "市立ひのはら保育所", type: "認定こども園", age: "0〜5歳", tel: "0439-88-5200", area: "中央地区" },
  { name: "市立北部保育所",     type: "保育所",       age: "0〜5歳", tel: "0439-53-2100", area: "北部地区" },
  { name: "市立原野保育所",     type: "保育所",       age: "0〜5歳", tel: "0439-54-1200", area: "原野地区" },
  { name: "白峰保育園",         type: "私立保育所",   age: "0〜5歳", tel: "0439-55-0300", area: "白峰地区" },
  { name: "日野原幼稚園",       type: "私立幼稚園",   age: "3〜5歳", tel: "0439-88-5500", area: "中央地区" },
];
        ...
        <main className="main-content">
          ...
          <div className="content-box" style={{ borderLeft: "4px solid #e91e63", background: "#fce4ec22", marginBottom: 20 }}>
            <p style={{ fontSize: 13, lineHeight: 1.9, margin: 0 }}>
              ...
              わからないことは<strong>子育て支援課（☎ 0439-88-1111 内線 241）</strong>にお気軽にご相談ください。
            </p>
          </div>
          ...
          <div className="content-box" style={{ background: "#fce4ec33", border: "1px solid #f8bbd0" }}>
            ...
            <table className="content-table">
              <tbody>
                ...
                <tr><th>電話</th><td>☎ <strong>0439-88-1111</strong>（内線 241）</td></tr>
          ...
          <PageInfo department="子育て支援課" tel="0439-88-1111（内線 241）" updated="令和8年4月1日" />
        </main>
        <Sidebar />
      </div>
      <SiteFooter />
