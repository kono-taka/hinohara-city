        ...
        <main className="main-content">
          ...
          <div className="content-box" style={{ borderTop: "none" }}>
            ...
            <p style={{ fontSize: 13, lineHeight: 1.9, margin: "0 0 12px" }}>
              ...
              明治の廃藩置県・郡制施行により日野郡が置かれ、日野町・原野村・白嶺村の三町村が形成されました。
            ...
            <p style={{ fontSize: 13, lineHeight: 1.9, margin: "0" }}>
              ...
              行政の効率化と地域の持続可能性を確保するため、平成18年（2006年）3月20日に旧日野町・原野村・白嶺村が合併して日野原市が誕生しました。
            ...
            <table className="content-table">
              <tbody>
                <tr>
                  ...
                  <td>房総丘陵の台地上に集落が形成される。市内各所で縄文土器・石器が出土（原野遺跡群・下白嶺貝塚ほか）。</td>
                </tr>
                <tr>
                  <th>弥生〜古墳時代</th>
                ...
                <tr>
                  <th>室町〜戦国時代</th>
                  <td>里見氏と後北条氏の抗争に巻き込まれ、白嶺山麓に防御用の山城（白嶺城跡）が築かれる。林業・炭焼きが盛んになる。</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table className="content-table">
              <tbody>
                ...
                <tr>
                  ...
                  <td>白嶺地区でびわの栽培が始まる。江戸への物資輸送路（日野街道）が整備される。</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="content-box" style={{ borderTop: "none" }}>
            <table className="content-table">
              <tbody>
                ...
                <tr>
                  <th>昭和55年（1980）</th>
                  <td>3村合計人口がピーク（約54,200人）に達する。白嶺温泉が観光開発され、旅館・ホテルが相次いで開業する。</td>
                </tr>
                <tr>
                  <th>平成3年（1991）</th>
            ...
            <table className="content-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>約92km²</td>
                  <td>約9,500人</td>
                  <td>市域南部の山間村。びわ栽培の発祥地で温泉地（白嶺温泉）としても知られる。豊かなブナ林が残る。</td>
                </tr>
              </tbody>
            </table>
          </div>
