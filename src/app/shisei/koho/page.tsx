...
const issues = [
  ...
  { year: "令和8年", month: "2月号", date: "2026年2月1日発行", no: "第239号", pages: 16, pdf: "/files/koho/r8-02.pdf",
    topics: ["特集：介護保険制度の改正点（令和8年度）", "白嶺地区 冬季道路凍結・倒木対策について", "市民活動団体紹介「NPO法人 ひのはら里山保全会」", "健康コラム「インフルエンザ予防のポイント」"] },
  ...
  { year: "令和7年", month: "11月号", date: "2025年11月1日発行", no: "第236号", pages: 16, pdf: "/files/koho/r7-11.pdf",
    topics: ["特集：落花生・びわの秋 ひのはら農業の今", "文化の秋 市民文化祭レポート", "高齢者なんでも相談窓口　利用者の声", "市民税・国民健康保険税の口座振替のご案内"] },
