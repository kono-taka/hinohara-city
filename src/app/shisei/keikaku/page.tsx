    ...
    <>
      ...
      <div className="main-container">
        <main className="main-content">
            ...
            {[
              {
                ...
                title: "豊かな自然と共生するまち",
                sub: "環境・農林業",
                policies: ["ゼロカーボンシティの実現（2050年カーボンニュートラル）", "農林業の持続的な発展と担い手育成", "白嶺高原・棚田等の自然環境・景観の保全", "生物多様性の保全と外来種対策"],
              },
              {
                num: "2",
                title: "安全・安心に暮らせるまち",
          ...
          <PageInfo department="企画政策課" division="総合計画係" tel="0100-88-1114（内線 101）" updated="令和5年3月31日" />
        </main>
        <Sidebar />
      </div>
      <SiteFooter />
