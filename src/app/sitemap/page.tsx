    ...
    subsections: [
      {
        ...
        pages: [
          ...
          { href: "/kyoiku/gakko/shirotaki-sho", label: "├ 白嶺小学校" },
    ...
    subsections: [
      {
        ...
        pages: [
          ...
          { href: "/news/seisosakugyou",      label: "白嶺地区 農業用水路 清掃作業" },
