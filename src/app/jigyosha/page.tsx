...
const faqs = [
  { q: "企業立地補助金を受けるための条件は何ですか？", a: "製造業・情報サービス業等が対象です。市内に工場・事業所を新設または増設し、新規雇用者を2名以上確保することが主な要件です。補助率・上限額は投資規模・雇用人数により異なります。詳しくは産業振興課（☎0100-88-1144）へ。" },
  { q: "市の入札に参加するには何が必要ですか？", a: "競争入札参加資格審査申請が必要です。申請は原則2年ごと（奇数年度）に受け付けています。必要書類・申請方法は市公式サイトの「入札・契約情報」ページをご覧ください。" },
  { q: "起業・創業の補助金はありますか？", a: "日野原市創業支援補助金（事業費の1/2・上限50万円）と、日野原市商工会の創業スクール受講者向け補助（上限10万円）があります。詳しくは産業振興課商工係（☎0100-88-1144）または商工会（☎0100-88-3300）へ。" },
  { q: "産業用地の空き情報を教えてください", a: "市内の産業団地・工場用地の空き情報は産業振興課（☎0100-88-1144）または千葉県企業立地相談センターでご確認いただけます。民間の事業用地は商工会でもご案内しています。" },
];
...
const contacts = [
  { dept: "産業振興課（商工・企業誘致）", tel: "0100-88-1144", ext: "内線 144", email: "sangyo@city.hinohara.lg.jp" },
  { dept: "農林振興課（農業・林業）",     tel: "0100-88-1143", ext: "内線 143", email: "norin@city.hinohara.lg.jp" },
  { dept: "総務課（入札・契約）",         tel: "0100-88-1111", ext: "内線 121", email: "soumu@city.hinohara.lg.jp" },
  { dept: "企画政策課（移住・テレワーク）", tel: "0100-88-1114", ext: "内線 114", email: "kikaku@city.hinohara.lg.jp" },
];
        ...
        <main className="main-content">
          ...
          <div className="content-box" style={{ borderLeft: "4px solid #1565c0", background: "#e3f2fd44" }}>
            <p style={{ fontSize: 13, lineHeight: 1.9, margin: 0 }}>
              ...
              事業規模や業種を問わず、まずは産業振興課（☎ 0100-88-1144）にお気軽にご相談ください。
            </p>
          </div>
          ...
          <div className="content-box" style={{ background: "#f0f4f9", border: "1px solid #c0d0e8" }}>
            ...
            <p style={{ fontSize: 12, color: "#555", marginTop: 8 }}>
              ...
              また、日野原市商工会（☎ 0100-88-3300）では経営・税務・融資に関する無料相談を随時受け付けています。
            </p>
          </div>

          <PageInfo department="産業振興課" tel="0100-88-1144（内線 144）" updated="令和8年4月1日" />
        </main>
        <Sidebar />
      </div>
      <SiteFooter />
