...
const allNews = [
  { date: "2026.06.12", tag: "info", label: "お知らせ", text: "第19回 日野原やまびこ祭り 開催に伴う交通規制・臨時駐車場のご案内", dept: "観光振興課", href: "/news/r8-yamabiko-koutsuu" },
  ...
  { date: "2026.05.20", tag: "info", label: "お知らせ", text: "白嶺地区 農業用水路 清掃作業への地域住民参加のお願い", dept: "農林振興課", href: "/news/seisosakugyou" },
  ...
  { date: "2026.05.12", tag: "bid", label: "入札・契約", text: "白嶺高原ビジターセンター 展示更新業務 プロポーザル実施のお知らせ", dept: "財政課" },
  ...
  { date: "2026.04.28", tag: "event", label: "イベント", text: "白嶺自然観察ウォーク2026 参加者募集（6月21日開催）", dept: "環境対策課" },
