...
const gifts = [
  ...
  {
    id: "H002",
    name: "白嶺温泉郷 旅館宿泊ペアご招待券（1泊2食）",
    amount: "50,000円以上",
    producer: "白嶺温泉旅館組合",
    desc: "ナトリウム塩化物泉の名湯・白嶺温泉郷の宿泊券。組合加盟6旅館の中からお選びいただけます。",
  ...
  {
    id: "H005",
    name: "白嶺高原牧場 乳製品詰め合わせ（チーズ・バター・ヨーグルト）",
    amount: "15,000円以上",
    producer: "有限会社 白嶺高原牧場",
        ...
        <main className="main-content">
          ...
          <div style={{ border: "1px solid var(--border-light)", borderTop: "none", background: "#fff", marginBottom: 16 }}>
            {[
              ...
              { no: "②", label: "自然環境・景観の保全", desc: "白嶺高原の森林整備・原野川の清流保全・鳥獣被害対策" },
              { no: "③", label: "農林業・地域産業の振興", desc: "びわ・落花生産地の競争力強化・新規就農者支援・商店街活性化" },
