...
export const metadata: Metadata = { title: "白峰温泉郷 旅館宿泊ペアご招待券（1泊2食）｜ふるさと納税" };
      ...
      <div className="main-container">
        <main className="main-content">
          <div className="breadcrumb">
            ...
            <span>白峰温泉郷 旅館宿泊ペアご招待券（1泊2食）</span>
          </div>
          <div style={{ display: "flex", gap: 16, marginBottom: 16 }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{ fontSize: 11, color: "#888", marginBottom: 4 }}>品番：H002　提供者：白峰温泉旅館組合</div>
              <h1 style={{ fontSize: 18, fontWeight: "bold", color: "var(--city-blue)", margin: "0 0 8px", lineHeight: 1.4 }}>
                白峰温泉郷 旅館宿泊ペアご招待券（1泊2食）
              </h1>
          ...
          <div className="content-box">
            ...
            <p style={{ fontSize: 13, lineHeight: 1.9, margin: 0 }}>
              ナトリウム塩化物泉の名湯・白峰温泉郷の宿泊ご招待券です。組合加盟6旅館（白峰の宿 美峰・旅館 野沢屋・民宿 雪割荘・ひのはら温泉 やまびこ・旅館 泉仙・ペンション白樺）の中からお好みの旅館をお選びいただけます。
            </p>
          </div>
