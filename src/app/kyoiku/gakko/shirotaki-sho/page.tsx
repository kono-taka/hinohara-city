...
export const metadata: Metadata = { title: "日野原市立白嶺小学校" };
        ...
        <main className="main-content">
          ...
          <div className="content-box">
            ...
            <table className="content-table">
              <tbody>
                <tr><th>所在地</th><td>〒298-8821　千葉県日野原市白嶺字学校台200番地</td></tr>
          ...
          <div className="content-box">
            ...
            <ul style={{ fontSize: 13, lineHeight: 2, margin: 0, paddingLeft: 20 }}>
              <li><strong>自然を活かした教育</strong>：白嶺高原での登山学習（4〜6年）・ブナ林の自然観察・冬の山歩き体験を毎年実施。</li>
              ...
              <li><strong>地域連携</strong>：白嶺地区の農家・温泉旅館・林業事業者との連携学習を実施。地域の方が学校応援ボランティアとして活動中。</li>
            </ul>
          </div>

          <div style={{ padding: 14, background: "#f4f6fb", border: "1px solid var(--border-light)", fontSize: 12, lineHeight: 1.8 }}>
            <strong>お問い合わせ</strong>　日野原市立白嶺小学校　☎ 0100-58-1200（平日 8:00〜17:00）<br />
            スクールバス（市街地〜白嶺）については学校または学校教育課（☎ 0100-88-1140）へ。
          </div>
