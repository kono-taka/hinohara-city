      ...
      <div className="main-container">
        <main className="main-content">
          ...
          <div className="content-box">
            ...
            <table className="content-table">
              ...
              <tbody>
                ...
                <tr><td>第2展示室</td><td><strong>日野原の歴史</strong>　古代から近代まで、旧日野町・原野村・白嶺村の歩みを写真・資料で紹介。明治期の農業・林業の道具類。</td></tr>
                <tr><td>第3展示室</td><td><strong>くらしの民具</strong>　農具・漁具・生活用品など約1,200点の民具を収蔵・展示。白嶺地区の養蚕・機織り道具の実物展示。</td></tr>
          ...
          <div className="content-box">
            ...
            <table className="content-table">
              <tbody>
                <tr><th>前期企画展</th><td>「白嶺の棚田と人々のくらし」（5月24日〜8月31日）</td></tr>
