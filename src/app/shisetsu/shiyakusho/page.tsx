        ...
        <main className="main-content">
          ...
          <div className="content-box">
            ...
            <table className="content-table">
              <tbody>
                ...
                <tr><th>FAX</th><td>0439-88-1119</td></tr>
          ...
          <div className="content-box">
            ...
            <table className="content-table">
              <tbody>
                {[
                  ["市民課（住民登録・マイナンバー）", "0439-88-1113"],
                  ["市民課（国民健康保険）", "0439-88-1113"],
                  ["税務課", "0439-88-1116"],
                  ["福祉課（障がい・生活保護）", "0439-88-1120"],
                  ["高齢者支援課（介護保険）", "0439-88-1121"],
                  ["健康推進課（健診・予防接種）", "0439-88-1122"],
                  ["子育て支援課（保育・児童手当）", "0439-88-1123"],
                  ["企画政策課（移住・ふるさと納税）", "0439-88-1114"],
                  ["建設課（道路・住宅）", "0439-88-1130"],
                  ["農林振興課", "0439-88-1135"],
                  ["環境対策課（ごみ）", "0439-88-1136"],
                ].map(([name, tel]) => (
          ...
          <PageInfo department="総務課" tel="0439-88-1121（内線 121）" updated="令和6年4月1日" />
        </main>
        <Sidebar />
      </div>
      <SiteFooter />
