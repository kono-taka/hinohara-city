...
const faqs = [
  ...
  { q: "バスでのアクセスは？", a: "日野原中央バスターミナルから会場まで徒歩約10分です。祭り期間中は君津駅・市内各所から臨時シャトルバスも運行予定（詳細は開催1か月前に公式発表）。" },
      ...
      <div className="main-container">
        <main className="main-content">
          ...
          <div className="content-box">
            ...
            <table className="content-table">
              <tbody>
                <tr><th>バス</th><td>日野原中央バスターミナルから会場まで徒歩約10分</td></tr>
                <tr><th>臨時シャトルバス</th><td>君津駅・市内各地から運行（開催1か月前に詳細発表・市HP・公式SNSでお知らせ）</td></tr>
