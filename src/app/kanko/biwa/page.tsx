...
const faqs = [
  ...
  { q: "びわ狩りの料金はいくらですか？", a: "農園ごとに料金が異なります。目安は大人1,500〜2,000円程度（食べ放題・30分）です。事前予約が必要な農園が多いため、観光案内所（☎0100-88-1150）または各農園へお問い合わせください。" },
  { q: "アクセス方法を教えてください。", a: "日野原中央バスターミナルから路線バス「本縄行き」で約20分。お車の場合は館山自動車道「君津IC」から約40分です。農園によって駐車場の有無が異なりますのでご確認ください。" },
      ...
      <div className="main-container">
        <main className="main-content">
          ...
          <div className="content-box">
            ...
            <table className="content-table">
              <tbody>
                <tr><th>バス</th><td>日野原中央バスターミナルから路線バス「本縄行き」乗車 約20分</td></tr>
          ...
          <div className="content-box" style={{ background: "#f0f4f9", border: "1px solid #c0d0e8" }}>
            ...
            <table className="content-table">
              <tbody>
                <tr><th>日野原市観光案内所</th><td>☎ <strong>0100-88-1150</strong></td></tr>
