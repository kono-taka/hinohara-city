...
const events = [
  ...
  { month: 6, day: 21, weekday: "土", title: "白嶺自然観察ウォーク2026", place: "白嶺ビジターセンター集合", time: "8:30〜15:00（雨天中止）", fee: "参加費500円", desc: "ネイチャーガイドとともに照葉樹林を歩く自然観察会。定員30名・要事前申込。" },
  ...
  { month: 7, day: 12, weekday: "日", title: "夏の星空観察会", place: "白嶺高原 天文台", time: "19:30〜21:30（雨天中止）", fee: "参加費300円", desc: "高原の澄んだ空気の下、天体望遠鏡で夏の星座を観察します。定員50名・要申込。" },
