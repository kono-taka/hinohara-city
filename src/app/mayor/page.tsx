        ...
        <main className="main-content">
          ...
          <div className="content-box" style={{ borderTop: "none" }}>
            <div className="mayor-message">
              ...
              <p>
                私たちのまちは、房総丘陵のなだらかな山並みに囲まれた、豊かな自然環境の中にあります。原野盆地に広がる市街地は標高230〜260mに位置し、大台山（382m）など起伏に富んだ地形が市域を包んでいます。原野川の清らかな流れ、白嶺高原に広がるブナの原生林。これらは、私たちの誇りであると同時に、次の世代へと引き継いでいかなければならない大切な財産です。
              </p>
              <p>
