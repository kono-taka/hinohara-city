        ...
        <main className="main-content">
          ...
          <div className="content-box" style={{ borderTop: "none" }}>
            <div className="mayor-message">
              ...
              <p>
                日野原市は、令和8年（2026年）3月に市制施行20周年という大きな節目を迎えました。平成18年3月に旧日野町、原野村、白峰村の三町村が合併してスタートしたこのまちが、地域の皆様の温かいご支援によって着実に歩みを続けてきたことに、市長として深く感謝申し上げます。
              </p>
              <p>
                私たちのまちは、標高800メートルを超える山間の豊かな自然環境の中にあります。日野原丘陵の緑豊かな山並み、原野川の清らかな流れ、そして白峰高原に広がるブナの原生林。これらは、私たちの誇りであると同時に、次の世代へと引き継いでいかなければならない大切な財産です。
              </p>
              <p>
                一方で、人口減少や少子高齢化といった課題は、本市においても例外なく進行しています。令和8年5月現在、総人口は42,381人。20年前の合併時に比べ、約9,200人の減少となっています。この流れを受け止めながら、しかし悲観することなく、小さくとも活力あるまちづくりを進めることが今の私たちの使命だと考えています。
              </p>
              <p>
          ...
          <div className="content-box" style={{ borderTop: "none" }}>
            <table className="content-table">
              <tbody>
                ...
                <tr><th>平成16年4月</th><td>千葉県 南房総地域振興事務所 地域振興課長</td></tr>
