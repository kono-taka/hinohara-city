      ...
      <div className="main-container">
        <main className="main-content">
          ...
          <div className="content-box">
            ...
            <p>日野原市は千葉県南房総地域に位置し、温暖な海洋性気候を活かした農業が盛んです。令和4年の農業産出額は<strong>38億円</strong>で、県内有数の農業地帯を形成しています。</p>
            <table className="content-table">
              ...
              <tbody>
                ...
                <tr><td>里芋</td><td>南房総の特産。ねっとりした食感が好評。収穫期：9〜11月</td><td>東京都心市場・直売所</td></tr>
                <tr><td>棚田米</td><td>房総丘陵の棚田で栽培されるコシヒカリ一等米。収穫期：9〜10月</td><td>農協出荷・地産地消・棚田オーナー制度</td></tr>
                <tr><td>菜の花</td><td>南房総名物。開花：1〜3月。菜種油への加工も盛ん</td><td>市場出荷・観光・油脂加工</td></tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="content-box">
            ...
            <table className="content-table">
              <tbody>
                <tr><th>所在地</th><td>日野原市原野字上原1234（国道19号線沿い）</td></tr>
